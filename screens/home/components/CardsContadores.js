    ...
    return (
        <View style={tw`px-1 mt-5 w-full`}>
            <View style={tw`flex-row justify-between flex-wrap bg-white rounded-lg p-2 shadow-lg`}>
                <View style={[tw`flex-col border-2 border-red-500 rounded-lg p-2`, { width: '24%' }]}>
                ...
                <View style={[tw`flex-col border-2 border-purple-500 rounded-lg p-2`, { width: '24%' }]}>
                ...
                <View style={[tw`flex-col border-2 border-yellow-500 rounded-lg p-2`, { width: '24%' }]}>
                ...
                <View style={[tw`flex-col border-2 border-green-500 rounded-lg p-2`, { width: '24%' }]}>
