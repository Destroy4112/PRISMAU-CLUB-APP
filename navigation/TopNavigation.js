...
export const TopNavigation = () => {
  ...
  const availableRoutes = useMemo(() => [
    { key: 'home', title: 'Inicio', icon: 'home-outline', component: HomeScreen, roles: [1, 2, 3, 4, 5, 6, 7] },
    ...
    { key: 'invitados', title: 'Invitados', icon: 'people-outline', component: EntradasInvitadosScreen, roles: [6, 7] },
    { key: 'profile', title: 'Perfil', icon: 'person-circle-outline', component: ProfileScreen, roles: [1, 2, 3, 4, 5, 6, 7] },
  ], []);
